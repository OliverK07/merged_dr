#ifndef IOTDATASPLTYPES_H
#define IOTDATASPLTYPES_H
...
extern c_metaObject __IoTData_DDS__load (c_base base);

extern c_metaObject __IoTData_DDS_IoT__load (c_base base);
...
extern  v_copyin_result __DDS_IoT_IoTNVP__copyIn(c_base base, const struct DDS::IoT::IoTNVP *from, struct _DDS_IoT_IoTNVP *to);
...
extern  v_copyin_result __DDS_IoT_IoTData__copyIn(c_base base, const struct DDS::IoT::IoTData *from, struct _DDS_IoT_IoTData *to);
