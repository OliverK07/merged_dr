 ...
 */
...
#ifndef __DATARIVERCHANNELLISTENER_H__
  #define __DATARIVERCHANNELLISTENER_H__
  ...
  // ------------------------------ Listeners ------------------------------
  class DataRiverChannelListener: public virtual DDS::DataReaderListener
  {

   public:

      bool m_closed;
      IoTDataDataReader_var m_IoTDataReader;
      DDS::GuardCondition_var m_guardCond;

      DataRiverChannelListener ()
      {
